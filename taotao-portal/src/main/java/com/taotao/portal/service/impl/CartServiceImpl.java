...
//    @Value("${CART_ITEMS_EXPIRE_TIME}")
     ...
     * @param response
     * @return
     * @see com.taotao.portal.service.CartService#addItem(Long, HttpServletRequest, HttpServletResponse)
     */
    @Override
...
//        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(cartItems), CART_ITEMS_EXPIRE_TIME, true);
        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(cartItems), (int) TimeUnit.MINUTES.toSeconds(30), true);
     ...
     *
     * @return
     * @see //com.taotao.portal.service.CartService.getCartItemsList(HttpServletRequest)
     */
    @Override
...
//        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(list), CART_ITEMS_EXPIRE_TIME, true);
        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(list), (int) TimeUnit.MINUTES.toSeconds(30), true);
...
//        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(itemsList), CART_ITEMS_EXPIRE_TIME, true);
        CookieUtils.setCookie(request, response, CART_ITEMS_LIST_KEY, JsonUtils.objectToJson(itemsList), (int) TimeUnit.MINUTES.toSeconds(30), true);
